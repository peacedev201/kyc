...
const VoltFailurePage = () => {
  ...
  function updateStatusTransactionFailure() {
    console.log("updateStatusTransactionFailure");
  ...
  useEffect(() => {
    if (transactionsUserList && transactionsUserList.objects.length > 0) {
      ...
      if (transaction.status !== TRANSACTIONS_STATUS_TYPES.REJECTED) {
        updateStatusTransactionFailure();
      } else {
        setLoading(false);
      }
    }
    ...
    <div className="page-user">
      ...
      <div className="page-content">
        <div className="container text-center">
          ...
          <h4>
            Payment pending! Please go to transactions dashboard to check status
            of this payment!
          </h4>
...
export default VoltFailurePage;
